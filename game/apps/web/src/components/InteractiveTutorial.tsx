...
const TUTORIAL_STEPS: TutorialStep[] = [
 {
  ...
  description: t('Картошка = $POTATO. Эмиссия — урожаи игроков, награды квестов и ½ налога маркета в казну; команда не продаёт токен отдельно.'),
  position: 'center',
 },
 {
  id: 'field',
 ...
 },
 {
  ...
  description: t('Неуплаченный налог = −50% к урожаю. Лицензия 500 SKR / 30 дней → −3% комиссии рынка. Покупка в КАЮТЕ.'),
  position: 'bottom',
 },
 {
  id: 'market',
 ...
 },
 {
  ...
  description: t('Ссылка в КАЮТЕ. Продавцу −1% от сделки, если покупатель пришёл по ссылке; рефереру +0.5% от каждой его сделки.'),
  position: 'bottom',
 },
 {
  id: 'done',
