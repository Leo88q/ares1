...
> Исторический аудит. Последующим решением владельца цена регистрации реферера
> подтверждена в **5 POTATO**; описанное ниже повышение до 50 больше не действует.
> Ставки реферальных выплат этим уточнением не меняются.
